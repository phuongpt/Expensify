            ...
            <SafeAreaView style={[styles.signInPage]}>
                ...
                >
                    <View style={[styles.mb4]}>
                        {/** The prop onSubmitEditing is required, but it needs to stay as a no-op because the form is submitted and validated from the button below, and adding a submit/validate here would trigger it twice */}
                        <NewPasswordForm
